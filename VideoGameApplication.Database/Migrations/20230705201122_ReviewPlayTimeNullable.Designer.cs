...
namespace VideoGameApplication.Database.Migrations
{
    ...
    [Migration("20230705201122_ReviewPlayTimeNullable")]
    partial class ReviewPlayTimeNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoGameApplication.Models.Entities.Developer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VideoGameApplication.Models.Entities.Genre", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VideoGameApplication.Models.Entities.Platform", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VideoGameApplication.Models.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DeveloperGame", b =>
                {
                    b.HasOne("VideoGameApplication.Models.Entities.Developer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GameGenre", b =>
                {
                    ...
                    b.HasOne("VideoGameApplication.Models.Entities.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GamePlatform", b =>
                {
                    ...
                    b.HasOne("VideoGameApplication.Models.Entities.Platform", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VideoGameApplication.Models.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VideoGameApplication.Models.Entities.Review", b =>
                {
                    ...
                    b.HasOne("VideoGameApplication.Models.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
